...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Improve your interview and presentation skills with privacy-first AI feedback on eye contact, pace, posture, and more." },
      { name: "author", content: "PresentIQ" },
      { property: "og:title", content: "PresentIQ — AI Interview & Presentation Coach" },
      { property: "og:description", content: "Objective, privacy-first feedback based on measurable speaking signals." },
